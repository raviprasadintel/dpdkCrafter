...
def update_system_time(new_time: str):
    """
    Updates the system time and refreshes package list.
    
    Parameters:
    new_time (str): Time in format 'YYYY-MM-DD HH:MM:SS'
    """
    try:
        # Disable NTP
        ...
        print("System time updated and package list refreshed.")
        
    except subprocess.CalledProcessError as e:
        print(f"Error occurred: {e}")

# Example usage
update_system_time("2025-10-17 15:30:00")
