...
# Script Class
class CryptoSetupManager(CommonMethodExecution):
    """
    ...
    def __init__(self,dts_setup_path, dpdk_file_path, automation_folder_path= "",git_user= "",git_token= "",qat_driver_path= "",fips_tar_file_path="",calgery_tar_file_path=""):
        ...
        self.config_folder_name = "config_files"
    ...
    def crypto_execution_script(self):
        ...
        try:
            ...
            CommonSetupCheck.print_separator("Starting prcoess")
            ...
            CommonSetupCheck.print_separator(f"Within Folder {str(os.getcwdb())}")
            ...
            CommonSetupCheck.print_separator(f"Current Path: {str(os.getcwdb())}")
            ...
            CommonSetupCheck.print_separator("Fetching Current List of Directory")
            ...
            if os.path.exists(dts_conf_path):
                ...
                # COPYING FILE :
                cp_config_folder_path = os.path.join(self.automation_folder_path,self.config_folder_name)
                ...
                CommonSetupCheck.print_separator(f"Back to DTS CONF FOLDER {str( os.getcwdb().decode() )}")
            ...
            updated = {
                "status":True,
                "error":"",
                "dts_driver_path": self.dts_setup_path,
                "config_file_folder_path": os.path.join(self.automation_folder_path,self.config_folder_name),
                "automation_folder_path": self.automation_folder_path
            }
